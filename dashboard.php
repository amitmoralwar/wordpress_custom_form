...
function wp_dashboard_quick_press( $error_msg = false ) {
	...
	<form name="post" action="<?php echo esc_url( admin_url( 'post.php' ) ); ?>" method="post" id="quick-press" class="initial-form hide-if-no-js">
		...
		<!--   !-->
		<!-- Custom form  of gold and silver price-->
		<form action="<?php $_PHP_SELF ?>" method="POST">
		<table>
		<tr>
		<h2>Enter the gold and silver price here!!!!</h2>
		</tr>
		<tr>
		Gold : <input type="text" name="gold_price" id="gold" autocomplete="off" />
		</tr><br><br>
		<tr>
		Silver : <input type="text" name="silver_price" id="silver" autocomplete="off" />
		</tr><br><br>
		<tr>
...
<?php
    ...
    $username = "i5637759_wp1";
    $password = "tushar";
    $dbname = "i5637759_wp1";
    $gold = $_POST['gold_price'];
    $silver = $_POST['silver_price'];
...
if(isset($_POST["add"])){
    ...
    $sql = "INSERT INTO gold_silver_price (gold,silver) VALUES ('$gold','$silver')";
